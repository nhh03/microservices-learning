...
public interface RatingRepository extends JpaRepository<Rating, Long> {
    Page<Rating> findByProductId(String id, Pageable pageable);
    ...
    List<Object[]> getTotalStarsAndTotalRatings(@Param("productId") String productId);

    boolean existsByCreatedByAndProductId(String createdBy, String productId);
}
