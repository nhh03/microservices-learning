...
@Builder
public record RatingVm(Long id, String content, int star, String productId, String productName, String createdBy,String lastName, String firstName, ZonedDateTime createdOn) {
